...
int main()
{
    ...
    int num_process = 3;// specify the number of process to use
    ...
    if ( world.rank() == 0 )
    {
        ...
        outfile1.open( "/scratch3/chris.tica/C++/1_5k_mom_1kdig/results/THIRD.txt",std::ios_base::out );
