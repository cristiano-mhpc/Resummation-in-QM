...
int main()
{
    ...
    vector<realtype> omega (omegas), firstter(omegas), secondter(omegas), thirdter(omegas), fifthter(omegas), fourthter(omegas), rezult(omegas);
    ...
    for (i=0; i < omegas; ++i)
    {
        rezult(i) = realtype(1) + firstter(i) + secondter(i) + thirdter(i) + fourthter(i) + fifthter(i);
